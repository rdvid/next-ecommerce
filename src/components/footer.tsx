...
export default function Footer(){
    return(
        <footer className="footer justify-center p-4 mt-5 inset-x-0 bg-base-300 lg:absolute">
            <div className="items-center grid-flow-col">
                ...
                <p>Copyright © 2023 - All right reserved - Made with <FontAwesomeIcon icon={faHeart} className="text-red-600"/> rdvid</p>
            </div> 
        </footer>
    );
}